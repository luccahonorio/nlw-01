...
const Points = () => {
    ...
    useEffect(()=>{
      async function loadPosition(){
        ...
        if(status !== 'granted'){
          Alert.alert('ops','precisamos de sua permissao para obter a localizao');
          return;
        }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.mapContainer}>
                { initialPosition[0] !== 0 && (
                  ...
                  {Points.map(point => (
                    <Marker key={String(point.id)} style={styles.mapMarker} coordinate={{latitude:point.latitude,longitude:point.longitude}} onPress={() =>handleNavigationToDetail(point.id)}>
